...
export class RegisterService {
  ...
  registerUserDataBase(id: number): Observable<any>{  
    return this.http.post<any>("http://localhost:8080/balance" , {id:id})
  }

  registerUserRecords(id: number): Observable<any>{  
    return this.http.post<any>("http://localhost:8080/records" , {id:id})
  }
  ...
  registerUserCDT( name:string ,id: number, BeginDate: string, PeriodMonths: string, investedMoney:number, ): Observable<any>{ 
    ...
    return this.http.post<any>("http://localhost:8080/cdt" ,{name:name,id:id,BeginDate:BeginDate,PeriodMonths:PeriodMonths,investedMoney:investedMoney}, {headers})
  }
